...
var AlertSearchService = (function () {
    function AlertSearchService(http) {
        this.http = http;
        this.viewUrl = 'http://localhost:8080/view/';
    }
    //not workin with it right now
    AlertSearchService.prototype.extractData = function (res) {
        var body = res.json();
        return body.data || {};
    };
    AlertSearchService.prototype.getS = function () {
        return this.http.get(this.viewUrl + 'instCost')
            .map(function (res) { return res.json(); });
    };
    AlertSearchService.prototype.handleError = function (error) {
